...
from .layer import SetSubjectLayer
...
class YowsupSetSubjectStack(object):
    def __init__(self, credentials, messages, encryptionEnabled = False):
        ...
        if encryptionEnabled:
            ...
            layers = (
                SetSubjectLayer,
                (YowAuthenticationProtocolLayer, YowGroupsProtocolLayer, YowReceiptProtocolLayer, YowAckProtocolLayer),
                YowLoggerLayer,
                YowCoderLayer,
                YowCryptLayer,
                YowStanzaRegulator,
        ...
        self.stack.setProp(SetSubjectLayer.PROP_MESSAGES, messages)
